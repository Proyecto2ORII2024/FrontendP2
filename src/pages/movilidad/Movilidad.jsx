...
const Movilidad = () => {
    const [movilidad] = useState([
        { dependencia: "Dependencia 5", c_convenio: "12789", t_documento: "CC", d_usuario: "12789" },
        { dependencia: "Dependencia 1", c_convenio: "123456789", t_documento: "CC", d_usuario: "123456789" },
        { dependencia: "Dependencia 2", c_convenio: "987654321", t_documento: "TI", d_usuario: "987654321" },
        { dependencia: "Dependencia 3", c_convenio: "456789123", t_documento: "CC", d_usuario: "456789123" },
        { dependencia: "Dependencia 1", c_convenio: "123456789", t_documento: "CC", d_usuario: "123456789" },
        { dependencia: "Dependencia 2", c_convenio: "987654321", t_documento: "TI", d_usuario: "987654321" },
        { dependencia: "Dependencia 3", c_convenio: "456789123", t_documento: "CC", d_usuario: "456789123" },
        { dependencia: "Dependencia 1", c_convenio: "123456789", t_documento: "CC", d_usuario: "123456789" },
    ...
    const [isFilterOpen, setIsFilterOpen] = useState(false); // Controla si el filtro está abierto
    ...
    const handleFilterChange = (e) => {
        ...
        setIsFilterOpen(false); // Cerrar el menú de filtro después de seleccionar
    };
    ...
    const sortedMovilidad = [...movilidad]
        ...
        .filter((item) => filterStatus ? item.dependencia === filterStatus : true) // Filtrar por dependencia
        .sort((a, b) => {
            ...
            return 0; // No ordenar si está en "default"
        });

    // Render de las flechas según la dirección del sort
                        ...
                        sortedMovilidad.map((item, index) => (
                            <tr key={index} className="border-t even:bg-azulClaro even:bg-opacity-10">
                                ...
                                <td className="px-4 py-2">
                                    {/* Acciones con los nuevos íconos */}
